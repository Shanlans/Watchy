...
- Current Phase (state machine): AcceptancePassed
- Last Completed Step: Build succeeded, bin + merged.bin generated
- Next Required Step: Flash to device
...
- Archive readiness: no (pending flash + device verification)
